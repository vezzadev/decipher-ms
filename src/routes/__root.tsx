    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          <a
            href="/"
            className="inline-flex items-center justify-center border-2 border-foreground/20 bg-background px-6 py-3 text-xs font-black uppercase tracking-widest text-foreground transition-colors hover:bg-foreground/5"
          >
            Go home
          </a>
        </div>
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "decipher.ms — Research desk for Microsoft clients" },
      {
        ...
        content:
          "Bypass generic research. Get written briefings and 1-on-1 calls with named analysts on Microsoft, Oracle, SAP, cloud architecture, and contract negotiation.",
      },
